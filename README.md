...
> 🎓 **Formação em Foco:** Cursando **Desenvolvimento de Sistemas** (SesiSenai) e **Tecnologia da Informação** (CentroWeg).

> 💻 **Objetivo:** Transformar problemas complexos em soluções eficientes através de código. Com forte base em **Python** e **Java**, busco oportunidades para aplicar meus conhecimentos em desenvolvimento de software e análise de dados, agregando valor real a projetos desafiadores.
